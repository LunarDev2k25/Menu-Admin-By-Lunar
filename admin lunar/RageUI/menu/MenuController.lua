    ...
    if CurrentMenu ~= nil then
        ...
        if CurrentMenu() then
            if (Options ~= 0) then
                ...
                TriggerEvent("InteractSound_CL:PlayOnOne", "audio", 0.5)
        ...
        if CurrentMenu() and (CurrentMenu.Display.Navigation) then
            ...
            if RageUI.Options > CurrentMenu.Pagination.Total then
                ...
                if CurrentMenu.EnableMouse then
                    ...
                    if UpHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, RageUI.Settings.Items.Navigation.Width + CurrentMenu.WidthOffset, RageUI.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
