    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if not Active then
                    RenderRectangle(CurrentMenu.X + 15, CurrentMenu.Y + 20 + SettingsButton.SelectedSprite.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.SelectedSprite.Width + CurrentMenu.WidthOffset - 55, SettingsButton.SelectedSprite.Height - 1, 16, 16, 16, 125)
                end
    
                if Selected then 
                    RenderRectangle(CurrentMenu.X + 15, CurrentMenu.Y + 20 + SettingsButton.SelectedSprite.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.SelectedSprite.Width + CurrentMenu.WidthOffset - 55, SettingsButton.SelectedSprite.Height - 1, 76, 36, 96, 255)
                end
                ...
                if Enabled == true or Enabled == nil then
                    if Selected then
                        RenderText(Label, 10 + CurrentMenu.X + SettingsButton.Text.X + LeftBadgeOffset, 21 + CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsButton.Text.Scale, 255, 255, 255, 255)
                        RenderText(ListText, CurrentMenu.X + SettingsList.Text.X + CurrentMenu.WidthOffset - RightOffset, 21 + CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsList.Text.Scale, 255, 255, 255, 255, 2)
                    else
                        RenderText(Label, 10 + CurrentMenu.X + SettingsButton.Text.X + LeftBadgeOffset, 21 + CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsButton.Text.Scale, 104, 108, 114, 255)
                        RenderText(ListText, CurrentMenu.X + SettingsList.Text.X + CurrentMenu.WidthOffset - RightOffset, 21 + CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsList.Text.Scale, 153, 153, 153, 255, 2)
                    end
                else
                    RenderText(Label, 28 + CurrentMenu.X + SettingsButton.Text.X + LeftBadgeOffset, 21 + CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsButton.Text.Scale, 163, 159, 148, 255)
                    
                    if Selected then
                        RenderText(ListText, 28 + CurrentMenu.X + SettingsList.Text.X + CurrentMenu.WidthOffset, 21 + CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsList.Text.Scale, 163, 159, 148, 255, 2)
                    else
                        RenderText(ListText, 28 + CurrentMenu.X + SettingsList.Text.X + 5 + CurrentMenu.WidthOffset, 21 + CurrentMenu.Y + SettingsList.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 8, SettingsList.Text.Scale, 163, 159, 148, 255, 2)
                    end
                end
