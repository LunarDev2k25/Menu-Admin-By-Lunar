...
RageUI.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 0, Width = 425 },
        Navigation = {
            Rectangle = { Width = 425, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenustaff", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 425, Height = 4 },
            Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 4, Width = 425, Height = 30 },
            Text = { X = 8, Y = 10, Scale = 0.26 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 4, Width = 425, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 4, Width = 425, Height = 76 },
...
function RageUI.Banner()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil and CurrentMenu.Sprite.Dictionary ~= nil and CurrentMenu.Sprite.Dictionary ~= 'commonmenustaffa' then
...
function RageUI.CreateMenu(Title, Subtitle, _, _, TextureDictionary, TextureName, _, _, _, _)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or "commonmenustaffa", Texture = TextureName or "interaction_bgd" }
    Menu.Rectangle = nil
...
function RageUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenustaffa", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end
...
function RageUI.Info(Title, RightText, LeftText)
    ...
    RenderSprite("commonmenustaff", "gradient_bgd", SettingsInfo.Rectangle.X + 20, SettingsInfo.Rectangle.Y + 62, SettingsInfo.Rectangle.Width, SettingsInfo.Rectangle.Height + (LineCount * 20), 0, 0, 0, 0, 255)
end
...
RageUI.BadgeStyle = {
    ...
    None = function()
        return {
            BadgeTexture = "",
            BadgeDictionary = "commonmenustaff"
        }
    end,
...
local SettingsButton = {
    ...
    SelectedSprite = { Dictionary = "commonmenustaff", Texture = "gradient_nav", Y = 40, Width = 432, Height = 31 },
}
            ...
            if Enabled then
                if haveLeftBadge then
                    if (Style.LeftBadge ~= nil) then
                        ...
                        RenderSprite(LeftBadge.BadgeDictionary or "commonmenustaff", LeftBadge.BadgeTexture or "", CurrentMenu.X + 25, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, LeftBadge.BadgeColour and LeftBadge.BadgeColour.R or 255, LeftBadge.BadgeColour and LeftBadge.BadgeColour.G or 255, LeftBadge.BadgeColour and LeftBadge.BadgeColour.B or 255, LeftBadge.BadgeColour and LeftBadge.BadgeColour.A or 255)
                    end
                end
                if haveRightBadge then
                    if (Style.RightBadge ~= nil) then
                        local RightBadge = Style.RightBadge(Active)
                        RenderSprite(RightBadge.BadgeDictionary or "commonmenustaff", RightBadge.BadgeTexture or "", CurrentMenu.X + 25 + SettingsButton.RightBadge.X + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.RightBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.RightBadge.Width, SettingsButton.RightBadge.Height, 0, RightBadge.BadgeColour and RightBadge.BadgeColour.R or 255, RightBadge.BadgeColour and RightBadge.BadgeColour.G or 255, RightBadge.BadgeColour and RightBadge.BadgeColour.B or 255, RightBadge.BadgeColour and RightBadge.BadgeColour.A or 255)
                    end
                end
...
local SettingsCheckbox = {
    Dictionary = "commonmenustaff", Textures = {
        "shop_box_blankb", -- 1
        "shop_box_tickb", -- 2
        "shop_box_blank", -- 3
        "shop_box_tick", -- 4
                ...
                if type(Style) == "table" then
                    if Style.Enabled == true or Style.Enabled == nil then
                        ...
                        if type(Style) == 'table' then
                            if Style.LeftBadge ~= nil then
                                if Style.LeftBadge ~= RageUI.BadgeStyle.None then
                                    ...
                                    RenderSprite(BadgeData.BadgeDictionary or "commonmenustaff", BadgeData.BadgeTexture or "", CurrentMenu.X, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, BadgeData.BadgeColour and BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.A or 255)
                                end
                            end
                            if Style.RightBadge ~= nil then
                                if Style.RightBadge ~= RageUI.BadgeStyle.None then
                                    local BadgeData = Style.RightBadge(Selected)
                                    RenderSprite(BadgeData.BadgeDictionary or "commonmenustaff", BadgeData.BadgeTexture or "", CurrentMenu.X + SettingsButton.RightBadge.X + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.RightBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.RightBadge.Width, SettingsButton.RightBadge.Height, 0, BadgeData.BadgeColour and BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.A or 255)
                                end
                            end
                        end
                    else
                        ...
                        if LeftBadge ~= RageUI.BadgeStyle.None and LeftBadge ~= nil then
                            ...
                            RenderSprite(BadgeData.BadgeDictionary or "commonmenustaff", BadgeData.BadgeTexture or "", CurrentMenu.X, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour.A or 255)
                        end
                    end
...
local SettingsList = {
    LeftArrow = { Dictionary = "commonmenustaff", Texture = "arrowleft", X = 398, Y = 3, Width = 25, Height = 25 },
    RightArrow = { Dictionary = "commonmenustaff", Texture = "arrowright", X = 420, Y = 3, Width = 25, Height = 25 },
                ...
                if type(Style) == "table" then
                    if Style.Enabled == true or Style.Enabled == nil then
                        if type(Style) == 'table' then
                            if Style.LeftBadge ~= nil then
                                if Style.LeftBadge ~= RageUI.BadgeStyle.None then
                                    ...
                                    RenderSprite(BadgeData.BadgeDictionary or "commonmenustaff", BadgeData.BadgeTexture or "", CurrentMenu.X + 25, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, BadgeData.BadgeColour and BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.A or 255)
                                end
                            end
                            ...
                            if Style.RightBadge ~= nil then
                                if Style.RightBadge ~= RageUI.BadgeStyle.None then
                                    ...
                                    RenderSprite(BadgeData.BadgeDictionary or "commonmenustaff", BadgeData.BadgeTexture or "", CurrentMenu.X + 25+ SettingsButton.RightBadge.X + CurrentMenu.WidthOffset, CurrentMenu.Y + SettingsButton.RightBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.RightBadge.Width, SettingsButton.RightBadge.Height, 0, BadgeData.BadgeColour and BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.A or 255)
                                end
                            end
                        end
                    else
                        ...
                        if LeftBadge ~= RageUI.BadgeStyle.None and LeftBadge ~= nil then
                            ...
                            RenderSprite(BadgeData.BadgeDictionary or "commonmenustaff", BadgeData.BadgeTexture or "", CurrentMenu.X + 25, CurrentMenu.Y + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour.A or 255)
                        end
                    end
                else
                    error("UICheckBox Style is not a `table`")
...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "commonmenustaff", Texture = "arrowleft", X = 235, Y = 46.5, Width = 20, Height = 20 },
    RightArrow = { Dictionary = "commonmenustaff", Texture = "arrowright", X = 405, Y = 46.5, Width = 20, Height = 20 },
}
...
local TextPanels = {
    Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 4, Width = 471, Height = 42 },
    Text = {
...
local Colour = {
    Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "commonmenustaff", Texture = "arrowleft", X = 7.5 + 25, Y = 15 + 40, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "commonmenustaff", Texture = "arrowright", X = 393.5 + 25, Y = 15 + 40, Width = 30, Height = 30 },
...
local Grid = {
    Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 275 },
...
local Percentage = {
    Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 54, Width = 425, Height = 50 },
...
local Slider = {
	Background = { Dictionary = "commonmenustaff", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 76 },
	Text = {
	...
	LeftArrow = { Dictionary = "commonmenustaff", Texture = "arrowleft", X = 12, Y = 32.5, Width = 25, Height = 25 },
	RightArrow = { Dictionary = "commonmenustaff", Texture = "arrowright", X = 389, Y = 32.5, Width = 25, Height = 25 },
}
...
function RageUI.SliderPanel(Value, MinValue, UpperText, MaxValue, Actions, Index)
	...
	if CurrentMenu ~= nil then
		if CurrentMenu() and ((CurrentMenu.Index == Index)) then
			...
			RenderSprite("commonmenustaff", "gradient_bgd", CurrentMenu.X, CurrentMenu.Y + Slider.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Slider.Background.Width + CurrentMenu.WidthOffset, Slider.Background.Height, 0.0, 255, 255, 255, 255)
