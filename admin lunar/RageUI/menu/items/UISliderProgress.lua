...
local SettingsSlider = {
    Background = { X = 230, Y = 34.5, Width = 150, Height = 9 },
    Slider = { X = 230, Y = 34.5, Width = 150, Height = 9 },
    LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 215, Y = 31.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 380, Y = 31.5, Width = 15, Height = 15 },
}
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if Enabled == true or Enabled == nil then
                    if Selected then
                        ...
                        RenderText(Label, CurrentMenu.X + SettingsButton.Text.X + LeftBadgeOffset, CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, SettingsButton.Text.Scale, 100, 100, 100, 255)
                    end
                else
